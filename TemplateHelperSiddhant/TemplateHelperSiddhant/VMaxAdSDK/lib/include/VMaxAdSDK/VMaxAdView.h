...
@property (strong, nonatomic) id cclasses;
...
//- (void)setAdOption:(AdOptionKey)adOptionKey adOptionValue:(AdOptionValue)adOptionValue;
//- (void)parse:(NSString *)payload adData:(NSData *)adData vmaxDataListener:(VmaxDataListener *) vmaxDataListener;
//- (void)render:(VmaxAdTemplateListener *)vmaxAdTemplateListener;
//@end
//
//NS_ASSUME_NONNULL_END
