...
+(void)setAccountId:(long)accountId; // (3.10.25) 12124536547  optional Story id 307  //story accountid
//&acc_id=12323534 any form of ad request single ad , multi ad
//if accunt id is set then remove validation of adspotkey-->Alphanumeric validation
...
+(BOOL)clearCachedMedia:(MediaType)mediaType;
