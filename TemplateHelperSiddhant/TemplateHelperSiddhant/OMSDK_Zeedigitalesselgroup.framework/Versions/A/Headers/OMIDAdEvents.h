 ...
 */
@interface OMIDZeedigitalesselgroupAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDZeedigitalesselgroupAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDZeedigitalesselgroupVASTProperties *_Nonnull)vastProperties
