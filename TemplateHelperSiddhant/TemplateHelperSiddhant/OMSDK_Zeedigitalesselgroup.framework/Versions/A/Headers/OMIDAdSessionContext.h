 ...
 */
@interface OMIDZeedigitalesselgroupAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDZeedigitalesselgroupPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDZeedigitalesselgroupPartner *)partner
                               ...
                               resources:(NSArray<OMIDZeedigitalesselgroupVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
