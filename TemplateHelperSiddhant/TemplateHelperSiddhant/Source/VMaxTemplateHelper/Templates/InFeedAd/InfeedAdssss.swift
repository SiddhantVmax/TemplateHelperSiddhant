...
@objc public class InfeedAdssss: VMaxAd {
    ...
    func storeData(templateName: String,payload: Data,vmaxDataListener: VmaxDataListener?,vmaxAdView: VMaxAdView,adData: NSDictionary) {
        if templateName != "" {
            ...
            self.vmaxAdTrackers = VmaxTracker(name: headerString)
...
//
    ...
    public override func render(_ vmaxAdTemplateListener: VmaxAdTemplateListener, adScreenType: NSNumber) {
...
extension InfeedAdssss: CtaButtonClicked {
    func icontapped() {
