 ...
 */
@interface OMIDZeedigitalesselgroupAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDZeedigitalesselgroupAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDZeedigitalesselgroupAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDZeedigitalesselgroupAdSessionContext *)context
